...
Config_init() {
  ...
  Config_rule_#19  := "TaskManagerWindow;.*;;1;0;1;0;1;0;"
...
Esc::
	set_key_layout_mode("Default")
return

#if get_key_layout_mode("Window")
	...
	;L::View_moveWindow(0, +1)
	;H::View_moveWindow(0, -1)
	+L::Monitor_setWindowtag(0,+1)Monitor_activateView(0,+1)
	+H::Monitor_setWindowtag(0,-1)Monitor_activateView(0,-1)
	L::Monitor_activateView(0,+1)
	H::Monitor_activateView(0,-1)
